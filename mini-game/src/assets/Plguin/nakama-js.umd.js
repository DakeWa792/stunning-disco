(function (root) {
  ...
  (function () {
    (function (global, factory) {
      typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.nakamajs = {}));
      ...
      ***************************************************************************** */
      ...
      const encode = (src, urlsafe = false) => urlsafe ? _mkUriSafe(_encode(src)) : _encode(src); // This trick is found broken https://github.com/dankogai/js-base64/issues/130
      ...
      var NakamaApi = function () {
        ...
        NakamaApi.prototype.healthcheck = function (bearerToken, options) {
          ...
          return Promise.race([fetch(fullUrl, fetchOptions).then(function (response) {
        ...
        NakamaApi.prototype.listChannelMessages = function (bearerToken, channelId, limit, forward, cursor, options) {
          ...
          var urlPath = "/v2/channel/{channelId}".replace("{channelId}", encodeURIComponent(String(channelId)));
          var queryParams = new Map();
        ...
        NakamaApi.prototype.deleteGroup = function (bearerToken, groupId, options) {
          ...
          var urlPath = "/v2/group/{groupId}".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
          var fetchOptions = buildFetchOptions("DELETE", options, bodyJson);
        ...
        NakamaApi.prototype.addGroupUsers = function (bearerToken, groupId, userIds, options) {
          ...
          var urlPath = "/v2/group/{groupId}/add".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
        ...
        NakamaApi.prototype.banGroupUsers = function (bearerToken, groupId, userIds, options) {
          ...
          var urlPath = "/v2/group/{groupId}/ban".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          queryParams.set("user_ids", userIds);
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
        ...
        NakamaApi.prototype.demoteGroupUsers = function (bearerToken, groupId, userIds, options) {
          ...
          var urlPath = "/v2/group/{groupId}/demote".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          queryParams.set("user_ids", userIds);
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
        ...
        NakamaApi.prototype.joinGroup = function (bearerToken, groupId, options) {
          ...
          var urlPath = "/v2/group/{groupId}/join".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
          var fetchOptions = buildFetchOptions("POST", options, bodyJson);
        ...
        NakamaApi.prototype.kickGroupUsers = function (bearerToken, groupId, userIds, options) {
          ...
          var urlPath = "/v2/group/{groupId}/kick".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          queryParams.set("user_ids", userIds);
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
        ...
        NakamaApi.prototype.leaveGroup = function (bearerToken, groupId, options) {
          ...
          var urlPath = "/v2/group/{groupId}/leave".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
          var fetchOptions = buildFetchOptions("POST", options, bodyJson);
        ...
        NakamaApi.prototype.promoteGroupUsers = function (bearerToken, groupId, userIds, options) {
          ...
          var urlPath = "/v2/group/{groupId}/promote".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          queryParams.set("user_ids", userIds);
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
        ...
        NakamaApi.prototype.listGroupUsers = function (bearerToken, groupId, limit, state, cursor, options) {
          ...
          var urlPath = "/v2/group/{groupId}/user".replace("{groupId}", encodeURIComponent(String(groupId)));
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("state", state);
          queryParams.set("cursor", cursor);
        ...
        NakamaApi.prototype.deleteLeaderboardRecord = function (bearerToken, leaderboardId, options) {
          ...
          var urlPath = "/v2/leaderboard/{leaderboardId}".replace("{leaderboardId}", encodeURIComponent(String(leaderboardId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
          var fetchOptions = buildFetchOptions("DELETE", options, bodyJson);
        ...
        NakamaApi.prototype.listLeaderboardRecordsAroundOwner = function (bearerToken, leaderboardId, ownerId, limit, expiry, options) {
          ...
          var urlPath = "/v2/leaderboard/{leaderboardId}/owner/{ownerId}".replace("{leaderboardId}", encodeURIComponent(String(leaderboardId))).replace("{ownerId}", encodeURIComponent(String(ownerId)));
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("expiry", expiry);
          var bodyJson = "";
        ...
        NakamaApi.prototype.listStorageObjects2 = function (bearerToken, collection, userId, limit, cursor, options) {
          ...
          var urlPath = "/v2/storage/{collection}/{userId}".replace("{collection}", encodeURIComponent(String(collection))).replace("{userId}", encodeURIComponent(String(userId)));
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("cursor", cursor);
          var bodyJson = "";
        ...
        NakamaApi.prototype.listTournamentRecords = function (bearerToken, tournamentId, ownerIds, limit, cursor, expiry, options) {
          ...
          var urlPath = "/v2/tournament/{tournamentId}".replace("{tournamentId}", encodeURIComponent(String(tournamentId)));
          var queryParams = new Map();
          queryParams.set("owner_ids", ownerIds);
          queryParams.set("limit", limit);
          queryParams.set("cursor", cursor);
        ...
        NakamaApi.prototype.joinTournament = function (bearerToken, tournamentId, options) {
          ...
          var urlPath = "/v2/tournament/{tournamentId}/join".replace("{tournamentId}", encodeURIComponent(String(tournamentId)));
          var queryParams = new Map();
          var bodyJson = "";
          var fullUrl = this.buildFullUrl(this.basePath, urlPath, queryParams);
          var fetchOptions = buildFetchOptions("POST", options, bodyJson);
        ...
        NakamaApi.prototype.listTournamentRecordsAroundOwner = function (bearerToken, tournamentId, ownerId, limit, expiry, options) {
          ...
          var urlPath = "/v2/tournament/{tournamentId}/owner/{ownerId}".replace("{tournamentId}", encodeURIComponent(String(tournamentId))).replace("{ownerId}", encodeURIComponent(String(ownerId)));
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("expiry", expiry);
          var bodyJson = "";
        ...
        NakamaApi.prototype.listUserGroups = function (bearerToken, userId, limit, state, cursor, options) {
          ...
          var urlPath = "/v2/user/{userId}/group".replace("{userId}", encodeURIComponent(String(userId)));
          var queryParams = new Map();
          queryParams.set("limit", limit);
          queryParams.set("state", state);
          queryParams.set("cursor", cursor);
        ...
        NakamaApi.prototype.buildFullUrl = function (basePath, fragment, queryParams) {
          ...
          try {
            for (var queryParams_1 = __values(queryParams), queryParams_1_1 = queryParams_1.next(); !queryParams_1_1.done; queryParams_1_1 = queryParams_1.next()) {
              var _b = __read(queryParams_1_1.value, 2),
                  k = _b[0],
                  v = _b[1];
      ...
      var DefaultSocket = function () {
        function DefaultSocket(host, port, useSSL, verbose, adapter) {
          ...
          if (adapter === void 0) {
            adapter = new WebSocketAdapterText();
          }
      ...
      var Client = function () {
        ...
        Client.prototype.addGroupUsers = function (session, groupId, ids) {
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  if (!(this.autoRefreshSession && session.refresh_token && session.isexpired((Date.now() + this.expiredTimespanMs) / 1000))) return [3, 2];
                ...
                case 2:
                  return [2, this.apiClient.addGroupUsers(session.token, groupId, ids).then(function (response) {
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.addFriends(session.token, ids, usernames).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
        ...
        Client.prototype.authenticateFacebookInstantGame = function (signedPlayerInfo, create, username, vars, options) {
          ...
          return this.apiClient.authenticateFacebookInstantGame(this.serverkey, "", {
            ...
            vars: request.vars
          }, create, username, options).then(function (apiSession) {
            return new Session(apiSession.token || "", apiSession.refresh_token || "", apiSession.created || false);
          });
        };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.banGroupUsers(session.token, groupId, ids).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.blockFriends(session.token, ids, usernames).then(function (response) {
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.createGroup(session.token, request).then(function (response) {
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.deleteFriends(session.token, ids, usernames).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.deleteGroup(session.token, groupId).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.deleteNotifications(session.token, ids).then(function (response) {
                    return Promise.resolve(response != undefined);
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.deleteStorageObjects(session.token, request).then(function (response) {
                    return Promise.resolve(response != undefined);
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.demoteGroupUsers(session.token, groupId, ids).then(function (response) {
                    return Promise.resolve(response != undefined);
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.event(session.token, request).then(function (response) {
                    return Promise.resolve(response != undefined);
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.getAccount(session.token)];
              }
            });
          });
        };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.importFacebookFriends(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.importSteamFriends(session.token, request, reset).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.getUsers(session.token, ids, usernames, facebookIds).then(function (response) {
                    var result = {
                      users: []
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.joinGroup(session.token, groupId, {}).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.joinTournament(session.token, tournamentId, {}).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.kickGroupUsers(session.token, groupId, ids).then(function (response) {
                    return Promise.resolve(response != undefined);
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.leaveGroup(session.token, groupId, {}).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listChannelMessages(session.token, channelId, limit, forward, cursor).then(function (response) {
                    var result = {
                      messages: [],
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listGroupUsers(session.token, groupId, limit, state, cursor).then(function (response) {
                    var result = {
                      group_users: [],
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listUserGroups(session.token, userId, state, limit, cursor).then(function (response) {
                    var result = {
                      user_groups: [],
                      cursor: response.cursor
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listGroups(session.token, name, cursor, limit).then(function (response) {
                    var result = {
                      groups: []
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkApple(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkCustom(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkDevice(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkEmail(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkFacebook(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkFacebookInstantGame(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkGoogle(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkGameCenter(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.linkSteam(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listFriends(session.token, limit, state, cursor).then(function (response) {
                    var result = {
                      friends: [],
                      cursor: response.cursor
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listLeaderboardRecords(session.token, leaderboardId, ownerIds, limit, cursor, expiry).then(function (response) {
                    var list = {
                      next_cursor: response.next_cursor,
                      prev_cursor: response.prev_cursor,
                      owner_records: [],
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listLeaderboardRecordsAroundOwner(session.token, leaderboardId, ownerId, limit, expiry).then(function (response) {
                    var list = {
                      next_cursor: response.next_cursor,
                      prev_cursor: response.prev_cursor,
                      owner_records: [],
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listMatches(session.token, limit, authoritative, label, minSize, maxSize, query)];
              }
            });
          });
        };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listNotifications(session.token, limit, cacheableCursor).then(function (response) {
                    var result = {
                      cacheable_cursor: response.cacheable_cursor,
                      notifications: []
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listStorageObjects(session.token, collection, userId, limit, cursor).then(function (response) {
                    var result = {
                      objects: [],
                      cursor: response.cursor
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listTournaments(session.token, categoryStart, categoryEnd, startTime, endTime, limit, cursor).then(function (response) {
                    var list = {
                      cursor: response.cursor,
                      tournaments: []
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listTournamentRecords(session.token, tournamentId, ownerIds, limit, cursor, expiry).then(function (response) {
                    var list = {
                      next_cursor: response.next_cursor,
                      prev_cursor: response.prev_cursor,
                      owner_records: [],
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.listTournamentRecordsAroundOwner(session.token, tournamentId, ownerId, limit, expiry).then(function (response) {
                    var list = {
                      next_cursor: response.next_cursor,
                      prev_cursor: response.prev_cursor,
                      owner_records: [],
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.promoteGroupUsers(session.token, groupId, ids)];
              }
            });
          });
        };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.readStorageObjects(session.token, request).then(function (response) {
                    var result = {
                      objects: []
                    };
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.rpcFunc(session.token, id, JSON.stringify(input)).then(function (response) {
                    return Promise.resolve({
                      id: response.id,
        ...
        Client.prototype.rpcHttpKey = function (httpKey, id, input) {
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              return [2, this.apiClient.rpcFunc2("", id, input && JSON.stringify(input) || "", httpKey).then(function (response) {
                return Promise.resolve({
                  id: response.id,
                  payload: !response.payload ? undefined : JSON.parse(response.payload)
                });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.sessionLogout(session.token, {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4, this.apiClient.sessionRefresh(this.serverkey, "", {
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkApple(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkCustom(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkDevice(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkEmail(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkFacebook(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkFacebookInstantGame(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkGoogle(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkGameCenter(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.unlinkSteam(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.updateAccount(session.token, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.updateGroup(session.token, groupId, request).then(function (response) {
                    return response !== undefined;
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.validatePurchaseApple(session.token, {
                    receipt: receipt
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.validatePurchaseGoogle(session.token, {
                    purchase: purchase
                  })];
              }
            });
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.validatePurchaseHuawei(session.token, {
                    purchase: purchase,
                    signature: signature
                  })];
              }
          ...
          return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
              switch (_a.label) {
                ...
                case 2:
                  return [2, this.apiClient.writeLeaderboardRecord(session.token, leaderboardId, {
